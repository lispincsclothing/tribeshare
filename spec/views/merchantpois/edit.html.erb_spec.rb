...
RSpec.describe "merchantpois/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit merchantpoi form" do
    render

    assert_select "form[action=?][method=?]", merchantpoi_path(@merchantpoi), "post" do

class HooksController < ApplicationController
  ...
  def create
    puts params.inspect
    puts "WHYNOTWORK ", params["hook"]["rfid"].to_s, params["hook"]["photon"].to_s
    puts "WHYNOTWORK ", Campaign.where(rfid:params["hook"]["rfid"].to_s), User.where(photon:params["hook"]["photon"].to_s)
